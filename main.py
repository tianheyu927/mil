...
# flags.DEFINE_integer('two_head_num_fc_layers', 3, 'number of fully-connected layers in the two-head architecture')
# flags.DEFINE_integer('two_head_layer_size', 100, 'hidden dimension of fully-connected layers in the two-head architecture')
# flags.DEFINE_bool('temporal_conv', False, 'whether or not to use temporal convolutions for the two-head architecture in video-only setting.')
# flags.DEFINE_integer('1d_filter_size', 5, 'filter size for temporal convolution')
# flags.DEFINE_integer('1d_num_filters', 64, 'number of filters for temporal convolution')
